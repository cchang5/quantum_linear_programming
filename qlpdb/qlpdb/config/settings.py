"""
Django settings for qlpdb project.
...
ROOT_URLCONF = "qlpdb.config.urls"
...
WSGI_APPLICATION = "qlpdb.config.wsgi.application"
...
MIGRATION_MODULES = {"notifications": "qlpdb.config.migrations.notifications"}
