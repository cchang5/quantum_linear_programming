...
While greedy algorithms do not guarantee optimal global solutions, they find feasible solutions--satisfying all constraints--in polynomial time, which can be utilized in further computations.
