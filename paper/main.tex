...
As this mapping comes with a tunable parameter, such constraints can be lifted in a problem-specific manner to extend the applicability (Sec.~\ref{sec:methods:ILP-on-DWave}).
